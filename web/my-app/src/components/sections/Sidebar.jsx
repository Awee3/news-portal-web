...
export default function Sidebar({ mainArticle, thumbArticles }) {
  ...
  const displayArticles = thumbArticles.length > 0 && thumbArticles.length <= 2 
  ...
  const totalSlides = Math.ceil(displayArticles.length / itemsPerPage);
    ...
    <aside className="w-full">
      ...
      <div className="mb-6 relative w-full">
        <div
          ...
          `}
          style={{ width: "372px", minHeight: "140px", gap: "16px" }} // sejajar kiri & senada lebar artikel
        >
          ...
          {currentItems.length === 2 && (
            <div
              className="pointer-events-none absolute left-1/2 -translate-x-1/2 w-px bg-gray-200 z-10"
      ...
      {/* Navigation controls */}
      <div className="flex items-center justify-center gap-3 mt-4 pb-4 border-b border-gray-200">
        <button
          onClick={prevSlide}
